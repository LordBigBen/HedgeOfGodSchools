...
setInterval(()=>{
    ...
    // increment counter
    headerCount++;
    if (headerCount >= headerimg.length) headerCount = 0; // loop back
...
setInterval(()=>{
    ...
    // increment counter
    loopCount++;
    if (loopCount >= aboutImg.length) loopCount = 0; // loop back to first
    // show current image
...
//# sourceMappingURL=HOG_main.2ac484ec.js.map
